...
1. Download the latest KPM release from [GitHub Releases](https://github.com/yourrepo/releases).
2. Transfer the binary to your Kindle.
...
See [Usage](usage.md) for basic commands.
